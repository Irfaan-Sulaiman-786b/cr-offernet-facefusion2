...
RUN mkdir -p /app/.assets/models && \
    ...
    curl -OL https://github.com/facefusion/models/releases/download/v1.0/yoloface_8n.onnx && \
    curl -OL https://github.com/facefusion/models/releases/download/v1.0/arcface_w600k_r50.onnx && \
    curl -OL https://github.com/facefusion/models/releases/download/v1.0/inswapper_128_fp16.onnx
